...
var AutoFileOrganizer = class extends import_obsidian3.Plugin {
  async onload() {
    ...
    this.addCommand({
      ...
      callback: async () => {
        ...
        new import_obsidian3.Notice("Files organized");
      }
    });
  }
  ...
  async organizeVault() {
    ...
    if (movedFiles.length > 0) {
      new import_obsidian3.Notice(`Moved ${movedFiles.length} files:
${movedFiles.join(", ")}`);
    } else {
      new import_obsidian3.Notice("No files were moved.");
    }
  }
  async updateExtensionMappingFromExistingFiles() {
    ...
    new import_obsidian3.Notice(`update extension-to-folder mapping`);
  }
  async updateTagMappingFromExistingFiles() {
    ...
    await this.saveSettings();
    new import_obsidian3.Notice(`update tag-to-folder mapping.`);
  }
};
